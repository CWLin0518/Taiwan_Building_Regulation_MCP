...
讓建築師事務所同仁直接用中文查詢《建築技術規則》及國土管理署解釋函令的 AI 工具，可協助尋找條文、函號、摘要與官方來源。
...
由資訊人員完成一次安裝後，在 AI 軟體中直接輸入問題，例如：

> 請搜尋建築技術規則中關於活載重的規定，列出條號及條文重點。

AI 若使用 `search_building_code` 並回傳結果，即代表工具已正常啟動。

## 建議怎麼問？

問題越具體，搜尋結果通常越準確。建議交代「想查的主題」及「希望 AI 如何整理」。

### 查法規條文

> 請查詢避難層出入口的相關規定，列出條號、條文內容及重點。

> 建築構造編對軟弱地層的基礎構造有哪些要求？

> 請找出昇降設備機房相關條文，並說明各條文的適用重點。

### 查解釋函令

> 請查詢採光相關的解釋函，列出發文日期、函號、摘要及官方連結。

> 請整理違章建築認定的相關解釋函，依日期由新到舊排列。

### 整理個案的初步法規依據

> 請分析頂樓加蓋可能涉及哪些建築技術規則，並查找相關解釋函。請分成「法規依據」、「函釋資料」、「待確認事項」三部分。

> 某辦公室要變更為餐飲使用，請列出可能需要檢查的防火避難議題及相關條文。若資料不足，請標示需要補充哪些案件條件。

正式工作建議在問題最後加上：

> 請列出引用條號、函號及官方來源連結；無法確認的部分不要自行推測。

## 提高搜尋準確度的小技巧

- 優先使用 1～3 個核心名詞，例如「活載重」、「防火區劃」、「直通樓梯」。
- 找不到結果時，改用法規中的正式名稱。例如把「逃生梯」改為「直通樓梯」或「安全梯」。
- 不確定用語時，可先請 AI 提出數組建議關鍵字，再分別查詢。
- 同一案件可能涉及不同條文，建議分項搜尋，不要只依賴第一筆結果。
- 查解釋函時，請明確寫出「解釋函」或「函釋」，並要求附上函號與官方連結。

## 如何看待查詢結果？

請把結果視為「協助檢索的初步資料」，而不是最終法規結論。使用前至少確認：

1. 條文是否為目前有效版本。
2. 條文所屬編、章、節及適用範圍是否符合案件。
3. 解釋函的日期、背景及前提是否與案件相同。
4. 個案是否另受都市計畫、土地使用、消防、無障礙、地方自治法規或其他規定限制。
5. 投標、簽證、請照、施工或法律救濟等重要決策，是否已由負責建築師或相關專業人員複核。

AI 的整理可能有遺漏或誤解；正式引用時，請開啟官方來源核對原文。
...
開啟新對話並明確輸入：「請使用台灣建築法規查詢工具，搜尋防火區劃相關條文。」若仍未出現工具，請聯絡資訊人員檢查 MCP 設定。
...
可能是官方網站、網路連線或工具使用的瀏覽器元件暫時異常。法規條文搜尋通常仍可使用，請將錯誤訊息交給資訊人員。
...
使用者應遵守相關法律及官方網站使用規範，不得以本工具惡意大量擷取或干擾政府系統運作。

---

# 資訊人員與維護者專區

以下是安裝、設定、更新及開發資訊，一般使用者不需要閱讀。
